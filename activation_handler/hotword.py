...
class HotwordDetector(Thread):
    """
    Wake word detection (aka Porcupine) library. It creates an input audio stream from a microphone,
        ...
        try:
            ...
            while True:
                ...
                if num_keywords == 1 and result:
                    ...
                    logging.info('[%s] detected %s' % (str(datetime.now()), keyword_names[result]))
